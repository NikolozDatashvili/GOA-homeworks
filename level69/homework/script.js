...
//   /// მოაშორეთ 'http://', 'https://', ან 'www.' url-ს დასაწყისიდან

//   url = url.replace(/(https?:\/\/)?(www\.)?/, "");
//   //// სფლიტი დაშორებული com და დომეინის ნაწილი განცალკევებისთვის
//   //// დავაბრუნოთ პირველი ელემენტი მასივი მნიშვნელობა (დომეინის სახელი)
//   return url.split(".")[0];
// }
